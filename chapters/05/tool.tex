...
\chapter{\MakeUppercase{\ChapterTitleFive}} \label{chap:tool}
    %\doublespacing
    \minitoc
    
    %\input{chapters/05/abstract}
    
    \setcounter{footnote}{\value{footnotecount}}
    
    \newpage
    \section{\MakeUppercase{Introduction}} \label{tool:intro}
    ...
    \section{\MakeUppercase{Working with RGS Data Files}} \label{tool:rgs-files}
        ...
        \subsection{Collecting Atomic Lines} \label{tool:rgs-files:line-collection}
            ...
            \subsubsection{The \texttt{AstroQuery} Python Module} \label{tool:rgs-files:line-collection:astroquery}
        ...
        \subsection{Demonstration} \label{tool:rgs-files:demonstration}
            ...
            \subsubsection{Doppler Shifts of Lines} \label{tool:rgs-files:demonstration:doppler}
                ...
                \begin{figure}[!htb]
    				\centering
    				\includegraphics[width=\textwidth]{images/mrvel_N-lines}
			    ...
			    \begin{figure}[!htb]
    				\centering
    				\includegraphics[width=\textwidth]{images/mrvel_O-lines}
			    ...
			    \begin{figure}[!htb]
    				\centering
    				\includegraphics[width=\textwidth]{images/mrvel_Fe-lines}
	...
	\section{\MakeUppercase{Relevance of Stellar Winds}} \label{tool:relevance}
	...
	\section{\MakeUppercase{Radiative Line-Driving: Mechanism of Stellar Winds}} \label{tool:radiative-line-driving}
		The physical mechanism which initiates and drives the outflow of matter from hot stars is known as radiative line driving. Illustrated in figure \ref{rad-line-drive-principle} is a qualitative description of the physical mechanism behind this process.
		...
		\begin{figure}[h!]
			\centering
			\subfloat[Absorption of photon \label{rad-line-drive:absorption}]{\includegraphics[height=3.5cm]{rad-line-drive-01}} \hfill
			\subfloat[Excitation of atom \label{rad-line-drive:excitation}] {\includegraphics[height=3.5cm]{rad-line-drive-02}} \hfill
			\subfloat[Re-emission of photon \label{rad-line-drive:reemission}] {\includegraphics[height=3.5cm]{rad-line-drive-03}}\\ %\hfill
...
\includepdf[pages={9,10}]{bibliography.pdf}
