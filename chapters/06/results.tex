	...
	\section{Variability study of \source} \label{results:variability}
		...
		\begin{table}[!htb]
			...
			\begin{tabular}{C{2.2cm}C{1.8cm}|C{2cm}C{2cm}C{2cm}C{2cm}|C{1.8cm}C{1.4cm}C{1.8cm}C{1.4cm}}
				...
				{} & {} & {\textbf{Freq. (mHz)}} & {\shortstack{\textbf{Period}\\ \textbf{(ks)}}} & {\textbf{Power per freq.}} & {\textbf{FAP}} & {\shortstack{$\boldsymbol{A}$\\ \textbf{(counts/s)}}} & {\shortstack{ $\boldsymbol{\phi}$\\ \textbf{(rad)}}} & {\shortstack{$\boldsymbol{C_0}$\\ \textbf{(counts/s)}}} & {\textbf{AMR}} \\
				\hline
