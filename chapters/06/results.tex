...
%    Sub-figure \ref{count-rate:all-norm}: To facilitate a more direct comparison between the source spectra that may have intrinsically different luminosities, this sub-figure presents the normalized count rates for all sources. The normalization scales the observed counts to a common range of 0 to 1. This allows for a clearer visualization of the spectral shapes across the sources, potentially revealing similarities or differences in their emission line profiles.
	...
	\section{Variability study of \source} \label{results:variability}
		...
		\subsection{Observed NICER and XMM-Newton lightcurves}
			The lightcurves of the SSS \source\ as observed by the observatories NICER and XMM-Newton are presented here. For the NICER observations, the lightcurves are extracted by combining timing data from all three observations mentioned in table \ref{tab:obs-journal}, and for XMM-Newton observations, the lightcurves are extracted from the timing data in observation ID 0111150101. Figures \ref{result:lc-mrvel-nicer} and \ref{result:lc-mrvel-xmm} display the lightcurves extracted over 0.2--1.0 keV and 0.2--12.0 keV photon energy ranges (the former is the range analysed in the multi-observatory spectral analysis of \source\ described in chapter \ref{chap:multi-obs}, whereas the latter is the full range for SSS).
			
			As expected, the count rates for the lightcurve extracted over the full SSS photon energy range is higher than that for the 0.2--1.0 keV range. This can be seen in figures \ref{result:lc-mrvel-nicer-countdiff} and \ref{result:lc-mrvel-xmm-countdiff} for a chosen sub-interval of observations. Figure \ref{result:lc-mrvel-xmm-countdiff} also shows that the count rates of the RGS observations are much smaller than the corresponding EPIC-pn observations.
			
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_lc-bothbands}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_lc-bothbands_11-13ks}
				\caption{Variation in count rates of \source\ for both photon energy ranges observed in NICER lightcurves}
				\label{result:lc-mrvel-nicer-countdiff}
			\end{figure}
			
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_0111150101_lc-allbands}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_0111150101_lc-allbands_93360-70ks}
				\caption{Variation in count rates of \source\ for both photon energy ranges observed in XMM-Newton lightcurves}
				\label{result:lc-mrvel-xmm-countdiff}
			\end{figure}
		...
		\subsection{Timing analysis of NICER lightcurve}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_ls-nicer-signalpeak}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_lc-nicer-phasefold-bestfit_58810s}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=\textwidth]{timing/rx-j0925_lc-nicer-bestfit_58810s}
...
%			\begin{figure}[h!]
%				\centering
%				\includegraphics[width=\textwidth]{timing/rx-j0925_lc-culled}
%				\caption{NICER lightcurve of \source\ over 0.2--1.0 keV photon energies}
%				\label{result:lc-mrvel-nicer}
%			\end{figure}
			
%			\begin{figure}[h!]
%				\centering
%				\includegraphics[width=\textwidth]{timing/rx-j0925_full-SSS_lc-culled}
%				\caption{NICER lightcurve of \source\ over 0.2--12.0 keV photon energies}
%				\label{result:lc-fullSSS-mrvel-nicer}
%			\end{figure}
			
%			\begin{figure}[h!]
%				\centering
%				\includegraphics[width=\textwidth]{timing/rx-j0925_EPN_0111150101_lc}
%				\caption{XMM-Newton lightcurve of \source\ over 0.2--1.0 keV photon energies}
%				\label{result:lc-mrvel-xmm}
%			\end{figure}
%			
%			\begin{figure}[h!]
%				\centering
%				\includegraphics[width=\textwidth]{timing/rx-j0925_EPN_full-SSS_0111150101_lc}
%				\caption{XMM-Newton lightcurve of \source\ over 0.2--12.0 keV photon energies}
%				\label{result:lc-fullSSS-mrvel-xmm}
%			\end{figure}
