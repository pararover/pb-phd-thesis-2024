output_type = 'lc'
output_detail = '-bothbands'

plt.figure(figsize=(10, 4), dpi=120)
plt.errorbar(t01.to(u.ks), rate01, yerr=rateError01, fmt='b.', alpha=0.5, label=band01, zorder=2)
plt.errorbar(t02.to(u.ks), rate02, yerr=rateError02, fmt='r.', alpha=0.5, label=band02, zorder=1)
