		...
		\subsection{Comparison with Current Literature}
			...
			\begin{table}[!htb]
				...
				\begin{tabular}{llc}
					...
					\multicolumn{2}{l}{Ebisawa \etal\ (2001) \cite{ebisawaAsca2001ApJ}} & 10.0 \\ %\hline
					\multicolumn{2}{l}{Bearda \etal\ (2002) \cite{beardaChandra2002AA}} & Not quoted \\ %\hline
					\multicolumn{2}{l}{Motch \etal\ (2002) \cite{motchXmmNewton2002AA}} & Not quoted \\ \hline
...
\includepdf[pages={7,8}]{bibliography.pdf}
