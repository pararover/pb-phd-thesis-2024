...
%    		\end{enumerate}
	...
	\begin{figure*}[htb!]
		...
		\caption*{Screenshot provided by Dr. Samrat Dey, former Editor-in-Chief of Journal of Applied \& Fundamental Sciences (JAFS), showing the inclusion of JAFS in UGC Approved List at the time of publication of paper no. \ref{paper-jafs}}
	\end{figure*}
	\end{landscape}