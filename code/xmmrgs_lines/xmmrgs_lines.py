...
def get_lyman_data():
	return [  {'ion':'C V', 'transition':'alpha', 'angstrom':40.2678}, {'ion':'C V', 'transition':'beta', 'angstrom':34.9728}, {'ion':'C V', 'transition':'gamma', 'angstrom':33.4262}, {'ion':'C VI', 'transition':'alpha', 'angstrom':33.7396}, {'ion':'C VI', 'transition':'beta', 'angstrom':28.4663}, {'ion':'C VI', 'transition':'gamma', 'angstrom':26.9901}, {'ion':'N VI', 'transition':'alpha', 'angstrom':28.787}, {'ion':'N VI', 'transition':'beta', 'angstrom':24.898}, {'ion':'N VI', 'transition':'gamma', 'angstrom':23.771}, {'ion':'N VII', 'transition':'alpha', 'angstrom':24.7846}, {'ion':'N VII', 'transition':'beta', 'angstrom':20.9106}, {'ion':'N VII', 'transition':'gamma', 'angstrom':19.8261}, {'ion':'O VII', 'transition':'alpha', 'angstrom':21.602}, {'ion':'O VII', 'transition':'beta', 'angstrom':18.627}, {'ion':'O VII', 'transition':'gamma', 'angstrom':17.768}, {'ion':'O VIII', 'transition':'alpha', 'angstrom':18.9725}, {'ion':'O VIII', 'transition':'beta', 'angstrom':16.0067}, {'ion':'O VIII', 'transition':'gamma', 'angstrom':15.1765}, {'ion':'Fe XVII', 'transition':'alpha', 'angstrom':17.0510}, {'ion':'Fe XVII', 'transition':'beta', 'angstrom':16.7760}, {'ion':'Fe XVII', 'transition':'gamma', 'angstrom':15.2620}, {'ion':'Fe XVIII', 'transition':'alpha', 'angstrom':16.0050}, {'ion':'Fe XVIII', 'transition':'beta', 'angstrom':14.3730}, {'ion':'Fe XVIII', 'transition':'gamma', 'angstrom':14.2080}]
