...
op_filename = plot_edge_overlay('mr-vel', idx, elem_list, (25.5, 36), ax, group_plot, sort_order, edge_df[edge_df['element'].isin(elem_list)], flux_lo=1E-19, flux_hi=1E-13, text_yposn=0.94)
